...
const Sidebar = () => {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden h-full w-full flex-col border-r border-gray-200 bg-gray-50 lg:flex dark:border-gray-800 dark:bg-gray-900">
        {/* Logo + Prodi Badge */}
      ...
      <nav className="flex items-center justify-around p-2 lg:hidden">
        {menuItems.map((item, index) => {
          const active = location === item.path;
          return (
            <Link
